...
class _ChatScreenState extends State<ChatScreen> {
  ...
  Future<Map<String, String?>> _getReceiverUserDetails(
    ...
    }; // Return nulls if no user was found
  }
  ...
  void _sendMessage(String message) async {
    ...
    Map<String, String?> receiverDetails =
        await _getReceiverUserDetails(widget.selectedUserName);
    ...
    await _firestore.collection('chats').doc(_getChatDocId()).set({
                ...
                Expanded(
                  child: StreamBuilder<QuerySnapshot>(
                    stream: _firestore
                        .collection('messages')
                        .where('sender',
                            whereIn: [_currentUserId, widget.selectedUserId])
                        .where('receiver',
                            whereIn: [_currentUserId, widget.selectedUserId])
                        .orderBy('timestamp',
                    ...
                    builder: (context, snapshot) {
                      ...
                      return ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          final messageData = messages[index].data() as Map<
                              String, dynamic>; // Ensure you get data as Map
                          ...
                          decoration: InputDecoration(
                            ...
                            focusedBorder: OutlineInputBorder(
                              ...
                              borderSide: BorderSide(
                                  color:
                                      Colors.orange), // Change to desired color
                            ),
                          ),
                        ),
                      ),
