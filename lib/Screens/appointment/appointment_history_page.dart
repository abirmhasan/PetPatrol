...
class _AppointmentHistoryPageState extends State<AppointmentHistoryPage>
  ...
  Widget _buildAppointmentCard(QueryDocumentSnapshot appointment) {
    ...
    String payment = appointment['payment'].toString();
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        image: DecorationImage(
                          image: NetworkImage(
                              doctorPhoto), // Doctor's photo from Firestore
                          fit: BoxFit.cover, // Cover the entire container
                        ),
                        borderRadius:
                            BorderRadius.zero, // Ensure no rounded corners
                      ),
                    ),
                    SizedBox(width: 16),
                    ...
                    ElevatedButton(
                      ...
                      style: ElevatedButton.styleFrom(
                        backgroundColor: Colors.orange[
                            500], // Change the button color to orange[100]
                      ...
                      child: const Text(
                        ...
                        style: TextStyle(
                          ...
                          fontWeight:
                              FontWeight.w600, // Optional: makes the text bold
                        ),
                      ),
                    ),
