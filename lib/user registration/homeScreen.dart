                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          SingleChildScrollView(
                            ...
                            child: Row(
                              children: [
                                _buildCategoryItem(Icons.schedule, "Team Info",
                                    onTap: () {
                                  Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                      builder: (context) =>
                                          TeamSaatScreen(), // Navigate to DoctorSearchPage
                                    ),
                                  );
                                }),
                                ...
                                _buildCategoryItem(Icons.schedule, "Notices",
                                    onTap: () {
                                  Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                      builder: (context) =>
                                          TermsAndConditionsScreen(), // Navigate to DoctorSearchPage
                                    ),
                                  );
                                })
                                //  _buildCategoryItem(
